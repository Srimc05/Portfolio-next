...
const SidebarHeader = () => {
  return (
    <div className="flex space-x-2">
      <Image
        src="https://ik.imagekit.io/sri05/WhatsApp%20Image%202025-07-09%20at%2015.25.12_97747419.jpg?updatedAt=1752054966374"
        alt="Avatar"
        height="40"
        width="40"
      ...
      <div className="flex text-sm flex-col">
        <p className="font-bold text-primary">Sri Sudhan mc</p>
